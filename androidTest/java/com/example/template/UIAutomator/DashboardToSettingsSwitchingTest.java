...
public class DashboardToSettingsSwitchingTest {
    ...
    @Test
    public void checkIfDashboardIsDisplayed() {
        UiObject title = device.findObject(new UiSelector().resourceId("com.example.template:id/DashboardTitle"));
